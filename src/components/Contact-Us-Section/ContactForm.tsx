...
export default function ContactForm() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    // Phone number with country code (replace with your WhatsApp number)
    const phoneNumber = "+918981985323";
...
Email: ${formData.email}`;
  ...
  return (
    <div className="max-w-xl w-full mx-auto rounded-none md:rounded-2xl p-4 md:p-8 bg-neutral-950 border">
